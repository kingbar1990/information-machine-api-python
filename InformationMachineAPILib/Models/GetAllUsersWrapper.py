"""
   InformationMachineAPILib.Models.GetAllUsersWrapper
...
class GetAllUsersWrapper(object):

    """Implementation of the 'GetAllUsersWrapper' model.

    TODO: type model description here.

    Attributes:
        result (list of UserData): TODO: type description here.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the GetAllUsersWrapper class
        ...
        Args:
            **kwargs: Keyword Arguments in order to initialise the
                ...
                that can be supplied and their types are as follows::
                    ...
                    result -- list of UserData -- Sets the attribute result
        ...
        if kwargs is not None:
            ...
            if "result" in kwargs:
                ...
                for item in kwargs["result"]:
                    self.result.append(UserData(**item))
