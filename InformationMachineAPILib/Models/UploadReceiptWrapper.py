"""
   InformationMachineAPILib.Models.UploadReceiptWrapper
...
class UploadReceiptWrapper(object):

    """Implementation of the 'UploadReceiptWrapper' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the UploadReceiptWrapper class
