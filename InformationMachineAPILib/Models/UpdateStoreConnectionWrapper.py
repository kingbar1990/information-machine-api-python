...
"""
   InformationMachineAPILib.Models.UpdateStoreConnectionWrapper
...
class UpdateStoreConnectionWrapper(object):

    """Implementation of the 'UpdateStoreConnectionWrapper' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the UpdateStoreConnectionWrapper class
