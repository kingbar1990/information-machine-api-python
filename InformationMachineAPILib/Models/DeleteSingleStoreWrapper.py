...
"""
   InformationMachineAPILib.Models.DeleteSingleStoreWrapper
...
class DeleteSingleStoreWrapper(object):

    """Implementation of the 'DeleteSingleStoreWrapper' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the DeleteSingleStoreWrapper class
