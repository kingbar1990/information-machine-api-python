...
"""
   InformationMachineAPILib.Models.GetUserProducts
...
class GetUserProducts(object):

    """Implementation of the 'GetUserProducts' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the GetUserProducts class
