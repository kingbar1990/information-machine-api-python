"""
   InformationMachineAPILib.Models.DeleteUserWrapper
...
class DeleteUserWrapper(object):

    """Implementation of the 'DeleteUserWrapper' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the DeleteUserWrapper class
