"""
   InformationMachineAPILib.Models.GetSingleUserStoreResponse
...
class GetSingleUserStoreResponse(object):

    """Implementation of the 'GetSingleUserStoreResponse' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the GetSingleUserStoreResponse class
