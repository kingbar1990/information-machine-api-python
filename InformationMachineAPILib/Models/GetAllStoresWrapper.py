"""
   InformationMachineAPILib.Models.GetAllStoresWrapper
...
class GetAllStoresWrapper(object):

    """Implementation of the 'GetAllStoresWrapper' model.

    TODO: type model description here.

    Attributes:
        result (list of UserStore): TODO: type description here.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the GetAllStoresWrapper class
        ...
        Args:
            **kwargs: Keyword Arguments in order to initialise the
                ...
                that can be supplied and their types are as follows::
                    ...
                    result -- list of UserStore -- Sets the attribute result
        ...
        if kwargs is not None:
            ...
            if "result" in kwargs:
                ...
                for item in kwargs["result"]:
                    self.result.append(UserStore(**item))
