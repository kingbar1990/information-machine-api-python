...
"""
   InformationMachineAPILib.Models.UploadReceiptStatusWrapper
...
class UploadReceiptStatusWrapper(object):

    """Implementation of the 'UploadReceiptStatusWrapper' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the UploadReceiptStatusWrapper class
