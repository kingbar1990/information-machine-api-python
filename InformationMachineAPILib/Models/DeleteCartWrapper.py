"""
   InformationMachineAPILib.Models.DeleteCartWrapper
...
class DeleteCartWrapper(object):

    """Implementation of the 'DeleteCartWrapper' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the DeleteCartWrapper class
