...
"""
   InformationMachineAPILib.Models.DeleteCartItemWrapper
...
class DeleteCartItemWrapper(object):

    """Implementation of the 'DeleteCartItemWrapper' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the DeleteCartItemWrapper class
