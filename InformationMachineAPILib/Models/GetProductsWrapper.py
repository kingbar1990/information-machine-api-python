...
"""
   InformationMachineAPILib.Models.GetProductsWrapper
...
class GetProductsWrapper(object):

    """Implementation of the 'GetProductsWrapper' model.

    TODO: type model description here.

    Attributes:
        result (list of ProductData): TODO: type description here.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the GetProductsWrapper class
        ...
        Args:
            **kwargs: Keyword Arguments in order to initialise the
                ...
                that can be supplied and their types are as follows::
                    ...
                    result -- list of ProductData -- Sets the attribute result
        ...
        if kwargs is not None:
            ...
            if "result" in kwargs:
                ...
                for item in kwargs["result"]:
                    self.result.append(ProductData(**item))
