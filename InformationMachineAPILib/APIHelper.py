...
class APIHelper:
    ...
    def json_serialize(obj):
        ...
        # Resolve any Names
        # if it's one of our objects that needs to have this called on
    ...
    def append_url_with_query_parameters(url,
        ...
        for key in parameters:
            ...
            if isinstance(element, list):
                ...
                url = url + '{0}{1}={2}'\
                    .format(separator, key, str(parameters[key]))
    ...
    def resolve_names(obj,
        ...
        for name in names:
            ...
            if isinstance(value, list):
                ...
                for key in value:
                    retval[names[name]][key] = APIHelper\
                        .resolve_name(value[key])
            else:
